<template>
  <TitleBar>
    ...
    <Badge variant="success" :with-bg="true"> tasdiqlangan</Badge>
  </TitleBar>
  ...
  >
    ...
    <div class="flex flex-row flex-wrap justify-start gap-40 font-bold">
      <div class="flex flex-col gap-5">
        ...
        <div>
          <p class="text-gray-400 uppercase font-bold text-sm">ajratilgan summa</p>
      ...
      <div class="flex flex-col gap-5">
        ...
        <div>
          <p class="text-gray-400 uppercase font-bold text-sm">kontrakt miqdori</p>
